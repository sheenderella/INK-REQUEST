        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              <input type={showPassword ? 'text' : 'password'} className="form-control border-black" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} required />
              <button type="button" className="btn btn-outline-dark" onClick={() => setShowPassword(!showPassword)}>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              <input type={showConfirmPassword ? 'text' : 'password'} className="form-control border-black" placeholder="Confirm password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
              <button type="button" className="btn btn-outline-dark" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
          ...
          <div className="text-center mt-2">
            <span className="text-muted" style={{ cursor: 'pointer' }} onClick={() => navigate('/')}>Already have an account? <strong>Login</strong></span>
          </div>
        </form>
      </div>
    </div>
